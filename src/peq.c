...
void
mm_peq_destroy(struct mm_peq *peq)
{
	ENTER();
...
static void
mm_peq_insert_fe(struct mm_peq *peq, struct mm_peq_item *item)
{
	ENTER();
...
static void
mm_peq_insert_t1(struct mm_peq *peq, struct mm_peq_item *item)
{
	ENTER();
...
struct mm_peq_item *
mm_peq_insert(struct mm_peq *peq, mm_timeval_t val, void *data)
{
	ENTER();
...
void
mm_peq_delete(struct mm_peq *peq, struct mm_peq_item *item)
{
	ENTER();
...
struct mm_peq_item *
mm_peq_getmin(struct mm_peq *peq)
{
	ENTER();
