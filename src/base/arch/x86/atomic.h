/*
 * base/arch/x86/atomic.h - MainMemory arch-specific atomic ops.
 *
...
#ifndef BASE_ARCH_X86_ATOMIC_H
#define BASE_ARCH_X86_ATOMIC_H
...
mm_atomic_cas(uintptr, "cmpxchgl", "r")
mm_atomic_cas_type(void *, ptr, "cmpxchgl", "r")
...
mm_atomic_fetch(uintptr, set, "", "xchgl", "r")
mm_atomic_fetch_type(void *, ptr, set, "", "xchgl", "r")
